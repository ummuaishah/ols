...
// $res = $autonum->single_autonumber(2);
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Modify Borrower</h6>
  </div>
  <div class="card-body"> 
          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-4 strecth">         
                     ...
                     <img id="blah" title="profile image" class="img-hover"    src="<?php echo web_root.'asset/images/'. $res->BorrowerPhoto; ?>" width="300px" height="200px"> 
