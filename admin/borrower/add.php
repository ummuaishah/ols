        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                 <select class="form-control input-sm" name="CourseYear" id="CourseYear" placeholder="Course-Year">
                    <option>Below 12 years old</option>
                    <option>12 - 17 years old</option>
                    <option>18 - 25 years old</option>
                    <option>26 - 35 years old</option>
                    <option>36 - 45 years old</option>
                    <option>Above 45 years old</option>
                </select>  
                <!--
          ...
          <!--refer for password and username
          <div class="form-group">
            <div class="row">
              <label class="col-md-2 control-label" for=
              "Lastname">Lastname:</label>
