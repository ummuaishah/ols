...
class Transaction{
	...
	protected static $tbl_name = "tbltransaction";
	function db_fields(){
		global $mydb;
		return $mydb->getFieldsOnOneTable(self::$tbl_name);
	}
	
	function find_all_transaction($IBSN=""){
			global $mydb;
	...
	function single_transaction($id){
			global $mydb;
			$mydb->setQuery("SELECT * FROM ".self::$tbl_name." Where TransactionID= {$id} LIMIT 1");
